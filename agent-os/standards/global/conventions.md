...
- **Supabase secrets**: Never embed service-role keys in client apps. Store secrets in Supabase or CI secrets; use `.env`/`supabase/config.toml` for local development.
