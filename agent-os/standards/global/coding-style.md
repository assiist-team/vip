...
- **Linters and formatters**: Enforce with project tools—`flutter_lints` and `dart format` (Dart), `black` and `flake8` (Python). Don't disable rules without documented justification.
